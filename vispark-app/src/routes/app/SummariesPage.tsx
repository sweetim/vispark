const summaries = [
  {
    ...
    summary: 'A comprehensive guide to understanding and using React Hooks, including useState, useEffect, and custom hooks.',
    thumbnailUrl: 'https://i.ytimg.com/vi/example1/hqdefault.jpg',
  },
  {
    id: '2',
    videoTitle: 'Next.js vs. Remix: A Deep Dive',
    summary: 'This video compares two popular React frameworks, Next.js and Remix, exploring their features, performance, and use cases.',
    thumbnailUrl: 'https://i.ytimg.com/vi/example2/hqdefault.jpg',
  },
  {
    id: '3',
    videoTitle: 'Building a REST API with Node.js and Express',
    summary: 'Learn how to build a robust REST API from scratch using Node.js, Express, and MongoDB for data persistence.',
    thumbnailUrl: 'https://i.ytimg.com/vi/example3/hqdefault.jpg',
  },
  {
    id: '4',
    videoTitle: 'Mastering TypeScript in 2025',
    summary: 'A complete guide to TypeScript, covering everything from basic types to advanced features like generics and decorators.',
